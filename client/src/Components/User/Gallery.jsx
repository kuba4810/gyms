...
class Gallery extends Component {
    ...
    render() {
        ...
        if (this.state.currentPhoto !== null) {
            image = <img className=" w-100 h-100 " src={`http://localhost:8080/public/images/${this.state.currentPhoto}.jpg`} />
        }
        return (
            // Container
            <div class="gallery animated invisible">
                ...
                {/* Image container */}
                <div className="bigImage mr-auto ml-auto w-50 h-50 position-relative mt-3 text-dark d-flex justify-content-center">
